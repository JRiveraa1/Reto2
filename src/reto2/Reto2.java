...
public class Reto2 {
    ...
    public static void Punto1(){
        ...
        System.out.print("Ingrese el número hasta el cual se harán cada tabla: ");
        num2 = leer.nextInt();
        System.out.print("Ingrese el número hasta el cual se harán las tablas: ");
        num1 = leer.nextInt();
    ...
    public static void Punto5(){
        ...
        nDivideM = nFac / (mFac * nLessMFac);
        System.out.println(nDivideM);
